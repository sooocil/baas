...
import { CreateAddressDTO, CreateAdjustmentDTO, CreateCartDTO, CreateLineItemDTO, CreateLineItemForCartDTO, CreateLineItemTaxLineDTO, CreateShippingMethodAdjustmentDTO, CreateShippingMethodDTO, CreateShippingMethodForSingleCartDTO, CreateShippingMethodTaxLineDTO, UpdateAddressDTO, UpdateCartDTO, UpdateLineItemDTO, UpdateLineItemTaxLineDTO, UpdateLineItemWithSelectorDTO, UpdateShippingMethodAdjustmentDTO, UpdateShippingMethodTaxLineDTO, UpsertLineItemAdjustmentDTO } from "./mutations";
export interface ICartModuleService extends IModuleService {
    ...
    removeLineItems(itemIds: string, sharedContext?: Context): Promise<void>;
    removeLineItems(selector: Partial<CartLineItemDTO>, sharedContext?: Context): Promise<void>;
    ...
    removeShippingMethods(methodIds: string, sharedContext?: Context): Promise<void>;
    removeShippingMethods(selector: Partial<CartShippingMethodDTO>, sharedContext?: Context): Promise<void>;
    ...
    addLineItemAdjustments(data: CreateAdjustmentDTO[]): Promise<LineItemAdjustmentDTO[]>;
    addLineItemAdjustments(data: CreateAdjustmentDTO): Promise<LineItemAdjustmentDTO[]>;
    addLineItemAdjustments(cartId: string, data: CreateAdjustmentDTO[]): Promise<LineItemAdjustmentDTO[]>;
    ...
    removeLineItemAdjustments(adjustmentIds: string, sharedContext?: Context): Promise<void>;
    removeLineItemAdjustments(selector: Partial<LineItemAdjustmentDTO>, sharedContext?: Context): Promise<void>;
    ...
    removeShippingMethodAdjustments(selector: Partial<ShippingMethodAdjustmentDTO>, sharedContext?: Context): Promise<void>;
    ...
    removeLineItemTaxLines(taxLineIds: string, sharedContext?: Context): Promise<void>;
    removeLineItemTaxLines(selector: FilterableLineItemTaxLineProps, sharedContext?: Context): Promise<void>;
    ...
    removeShippingMethodTaxLines(taxLineIds: string, sharedContext?: Context): Promise<void>;
    removeShippingMethodTaxLines(selector: FilterableShippingMethodTaxLineProps, sharedContext?: Context): Promise<void>;
}
