...
import { IEventBusService, IInventoryService, InventoryItemDTO, InventoryLevelDTO, IStockLocationService, ReservationItemDTO, ReserveQuantityContext } from "@medusajs/types";
...
declare class ProductVariantInventoryService extends TransactionBaseService {
    ...
    constructor({ salesChannelLocationService, salesChannelInventoryService, productVariantService, eventBusService, }: InjectedDependencies);
    /**
