...
export type StepFunctionResult<TOutput extends unknown | unknown[] = unknown> = (this: CreateWorkflowComposerContext) => WorkflowData<{
...
export type StepFunction<TInput, TOutput = unknown> = (keyof TInput extends [] ? {
    ...
    } : WorkflowData<TInput> | TInput): WorkflowData<{
        [K in keyof TOutput]: TOutput[K];
    }>;
