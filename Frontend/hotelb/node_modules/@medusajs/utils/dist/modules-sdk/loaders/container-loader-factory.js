...
var abstract_service_factory_1 = require("../abstract-service-factory");
...
function loadModuleServices(_a) {
    ...
    Object.values(moduleModels).forEach(function (Model) {
        ...
        if (!finalService) {
            moduleServicesMap.set(mappedServiceName, (0, abstract_service_factory_1.abstractServiceFactory)(Model));
        }
    });
