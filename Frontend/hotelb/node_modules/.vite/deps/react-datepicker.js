import {
  arrow,
  useFloating
} from "./chunk-JYFI73G2.js";
import {
  init_index_esm
} from "./chunk-DKSNSZX4.js";
import {
  autoUpdate,
  flip,
  floor,
  ...
  function o(r2) {
    ...
    we(this, o), Ce(Pe(n2 = fe(this, o, [r2])), "renderOptions", function() {
      var t2 = n2.props.year, r3 = n2.state.yearsList.map(function(r4) {
        return import_react3.default.createElement("div", { className: t2 === r4 ? "react-datepicker__year-option react-datepicker__year-option--selected_year" : "react-datepicker__year-option", key: r4, onClick: n2.onChange.bind(Pe(n2), r4), "aria-selected": t2 === r4 ? "true" : void 0 }, t2 === r4 ? import_react3.default.createElement("span", { className: "react-datepicker__year-option--selected" }, "✓") : "", r4);
...
var xt = function(t2) {
  function r2() {
    ...
    return Ce(Pe(t3 = fe(this, r2, [].concat(o))), "state", { dropdownVisible: false }), Ce(Pe(t3), "renderSelectOptions", function() {
      ...
      return import_react3.default.createElement(Pt, { key: "dropdown", year: t3.props.year, onChange: t3.onChange, onCancel: t3.toggleDropdown, minDate: t3.props.minDate, maxDate: t3.props.maxDate, scrollableYearDropdown: t3.props.scrollableYearDropdown, yearDropdownItemNumber: t3.props.yearDropdownItemNumber });
...
var Tt = function(t2) {
  function r2() {
    ...
    return Ce(Pe(t3 = fe(this, r2, [].concat(o))), "state", { dropdownVisible: false }), Ce(Pe(t3), "renderSelectOptions", function(t4) {
      ...
      return import_react3.default.createElement(Yt, { key: "dropdown", month: t3.props.month, monthNames: r3, onChange: t3.onChange, onCancel: t3.toggleDropdown });
  ...
  function n(t3) {
    ...
    return we(this, n), Ce(Pe(r2 = fe(this, n, [t3])), "renderOptions", function() {
      return r2.state.monthYearsList.map(function(t4) {
        ...
        return import_react3.default.createElement("div", { className: o ? "react-datepicker__month-year-option--selected_month-year" : "react-datepicker__month-year-option", key: n2, onClick: r2.onChange.bind(Pe(r2), n2), "aria-selected": o ? "true" : void 0 }, o ? import_react3.default.createElement("span", { className: "react-datepicker__month-year-option--selected" }, "✓") : "", Le(t4, r2.props.dateFormat, r2.props.locale));
      });
...
var Rt = function(t2) {
  function r2() {
    ...
    return Ce(Pe(t3 = fe(this, r2, [].concat(o))), "state", { dropdownVisible: false }), Ce(Pe(t3), "renderSelectOptions", function() {
      ...
      return import_react3.default.createElement(Ot, { key: "dropdown", date: t3.props.date, dateFormat: t3.props.dateFormat, onChange: t3.onChange, onCancel: t3.toggleDropdown, minDate: t3.props.minDate, maxDate: t3.props.maxDate, scrollableMonthYearDropdown: t3.props.scrollableMonthYearDropdown, locale: t3.props.locale });
    }), Ce(Pe(t3), "renderScrollMode", function() {
      var e2 = t3.state.dropdownVisible, r3 = [t3.renderReadView(!e2)];
      return e2 && r3.unshift(t3.renderDropdown()), r3;
    }), Ce(Pe(t3), "onChange", function(e2) {
...
var Lt = function(t2) {
  function n() {
    ...
    for (var o = arguments.length, a = new Array(o), s = 0; s < o; s++)
      a[s] = arguments[s];
    return Ce(Pe(t3 = fe(this, n, [].concat(a))), "dayEl", import_react3.default.createRef()), Ce(Pe(t3), "handleClick", function(e2) {
      ...
      return import_react3.default.createElement("div", { ref: t3.dayEl, className: t3.getClassNames(t3.props.day), onKeyDown: t3.handleOnKeyDown, onClick: t3.handleClick, onMouseEnter: t3.handleMouseEnter, tabIndex: t3.getTabIndex(), "aria-label": t3.getAriaLabel(), role: "option", title: t3.getTitle(), "aria-disabled": t3.isDisabled(), "aria-current": t3.isCurrentDay() ? "date" : void 0, "aria-selected": t3.isSelected() || t3.isInRange() }, t3.renderDayContents(), "" !== t3.getTitle() && import_react3.default.createElement("span", { className: "overlay" }, t3.getTitle()));
    }), t3;
  }
...
var Ft = function(t2) {
  function n() {
    ...
    for (var r2 = arguments.length, o = new Array(r2), a = 0; a < r2; a++)
      o[a] = arguments[a];
    return Ce(Pe(t3 = fe(this, n, [].concat(o))), "weekNumberEl", import_react3.default.createRef()), Ce(Pe(t3), "handleClick", function(e2) {
...
var jt = function(t2) {
  ...
  return Me(n, import_react3.default.Component), Se(n, [{ key: "render", value: function() {
    ...
    return import_react3.default.createElement("div", { className: this.getClassNames(), onMouseLeave: this.handleMouseLeave, "aria-label": "".concat(s, " ").concat(Le(o, "yyyy-MM")), role: "listbox" }, r2 ? this.renderMonths() : n2 ? this.renderQuarters() : this.renderWeeks());
  } }]), n;
}();
var Vt = function(t2) {
  function r2() {
    ...
    return Ce(Pe(t3 = fe(this, r2, [].concat(o))), "state", { height: null }), Ce(Pe(t3), "scrollToTheSelectedTime", function() {
      ...
      return r3.map(function(r4, o3) {
        return import_react3.default.createElement("li", { key: o3, onClick: t3.handleClick.bind(Pe(t3), r4), className: t3.liClasses(r4), ref: function(e2) {
          r4 === m && (t3.centerLi = e2);
        }, onKeyDown: function(e2) {
...
var qt = function(t2) {
  ...
  return Me(n, import_react3.default.Component), Se(n, [{ key: "render", value: function() {
    for (var t3 = this, r2 = [], n2 = this.props, o = n2.date, a = n2.yearItemNumber, s = n2.onYearMouseEnter, i = n2.onYearMouseLeave, p = Ct(o, a), c = p.startPeriod, l = p.endPeriod, d = function(n3) {
      ...
      d(u);
    return import_react3.default.createElement("div", { className: this.getYearContainerClassNames() }, import_react3.default.createElement("div", { className: "react-datepicker__year-wrapper", onMouseLeave: this.props.clearSelectingDate }, r2));
  } }]), n;
}();
var Ut = function(t2) {
  function r2(t3) {
...
function zt(t2) {
  ...
  return import_react3.default.createElement("div", { className: r2 }, n);
}
  ...
  function n(t3) {
    ...
    return we(this, n), Ce(Pe(o = fe(this, n, [t3])), "handleClickOutside", function(e2) {
      ...
      if (o.props.showYearDropdown && !t4)
        return import_react3.default.createElement(xt, { adjustDateOnChange: o.props.adjustDateOnChange, date: o.state.date, onSelect: o.props.onSelect, setOpen: o.props.setOpen, dropdownMode: o.props.dropdownMode, onChange: o.changeYear, minDate: o.props.minDate, maxDate: o.props.maxDate, year: getYear(o.state.date), scrollableYearDropdown: o.props.scrollableYearDropdown, yearDropdownItemNumber: o.props.yearDropdownItemNumber });
    }), Ce(Pe(o), "renderMonthDropdown", function() {
      var t4 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (o.props.showMonthDropdown && !t4)
        return import_react3.default.createElement(Tt, { dropdownMode: o.props.dropdownMode, locale: o.props.locale, onChange: o.changeMonth, month: getMonth(o.state.date), useShortMonthInDropdown: o.props.useShortMonthInDropdown });
    }), Ce(Pe(o), "renderMonthYearDropdown", function() {
      var t4 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (o.props.showMonthYearDropdown && !t4)
        return import_react3.default.createElement(Rt, { dropdownMode: o.props.dropdownMode, locale: o.props.locale, dateFormat: o.props.dateFormat, onChange: o.changeMonthYear, minDate: o.props.minDate, maxDate: o.props.maxDate, date: o.state.date, scrollableMonthYearDropdown: o.props.scrollableMonthYearDropdown });
      ...
      return import_react3.default.createElement("div", { className: "react-datepicker__header react-datepicker-year-header" }, n2 ? "".concat(s, " - ").concat(i) : getYear(t4));
      ...
      if (o.props.showTimeInput)
        return import_react3.default.createElement(Ut, { date: t4, timeString: r2, timeInputLabel: o.props.timeInputLabel, onChange: o.props.onTimeChange, customTimeInput: o.props.customTimeInput });
...
var rr = (tr = function(t2) {
  ...
  return Me(n, import_react3.default.Component), Se(n, [{ key: "render", value: function() {
    ...
    if (!s) {
      ...
      t3 = import_react3.default.createElement(er, { enableTabLoop: c }, import_react3.default.createElement("div", { ref: h.refs.setFloating, style: h.floatingStyles, className: f, "data-placement": h.placement, onKeyDown: l }, i, m && import_react3.default.createElement(FloatingArrow, { ref: h.arrowRef, context: h.context, fill: "currentColor", strokeWidth: 1, height: 8, width: 16, style: { transform: "translateY(-1px)" }, className: "react-datepicker__triangle" })));
    }
    this.props.popperContainer && (t3 = import_react3.default.createElement(this.props.popperContainer, {}, t3)), d && !s && (t3 = import_react3.default.createElement(Xt, { portalId: d, portalHost: u }, t3));
    var y = (0, import_classnames.default)("react-datepicker-wrapper", a);
    return import_react3.default.createElement(import_react3.default.Fragment, null, import_react3.default.createElement("div", { ref: h.refs.setReference, className: y }, p), t3);
  } }], [{ key: "defaultProps", get: function() {
  ...
  return import_react3.default.createElement(tr, _e({}, r2, { popperProps: De(De({}, o), {}, { arrowRef: n }) }));
});
...
var sr = function(t2) {
  function s(t3) {
    ...
    return we(this, s), Ce(Pe(i = fe(this, s, [t3])), "getPreSelection", function() {
      ...
      return i.props.inline || i.isCalendarOpen() ? import_react3.default.createElement(or, { ref: function(e2) {
        i.calendar = e2;
      ...
      var t4, n = (0, import_classnames.default)(i.props.className, Ce({}, nr, i.state.open)), o = i.props.customInput || import_react3.default.createElement("input", { type: "text" }), a = i.props.customInputRef || "ref", s2 = "string" == typeof i.props.value ? i.props.value : "string" == typeof i.state.inputValue ? i.state.inputValue : i.props.selectsRange ? function(e2, t5, r2) {
        if (!e2)
          return "";
      ...
      return !n || null == a && null == s2 && null == p ? null : import_react3.default.createElement("button", { type: "button", className: (0, import_classnames.default)("react-datepicker__close-icon", d, { "react-datepicker__close-icon--disabled": o }), disabled: o, "aria-label": h, onClick: i.onClearClick, title: c, tabIndex: -1 });
  ...
  return Me(s, import_react3.default.Component), Se(s, [{ key: "componentDidMount", value: function() {
    ...
    return import_react3.default.createElement("div", { className: "react-datepicker__input-container".concat(r2 ? " react-datepicker__view-calendar-icon" : "") }, r2 && import_react3.default.createElement(Jt, _e({ icon: n, className: "".concat(o, " ").concat(s2 && "react-datepicker-ignore-onclickoutside") }, a ? { onClick: this.toggleCalendar } : null)), this.state.isRenderAriaLiveMessage && this.renderAriaLiveRegion(), this.renderDateInput(), this.renderClearButton());
  } }, { key: "render", value: function() {
    var t3 = this.renderCalendar();
    if (this.props.inline)
      return t3;
    if (this.props.withPortal) {
      var r2 = this.state.open ? import_react3.default.createElement(er, { enableTabLoop: this.props.enableTabLoop }, import_react3.default.createElement("div", { className: "react-datepicker__portal", tabIndex: -1, onKeyDown: this.onPortalKeyDown }, t3)) : null;
      return this.state.open && this.props.portalId && (r2 = import_react3.default.createElement(Xt, { portalId: this.props.portalId, portalHost: this.props.portalHost }, r2)), import_react3.default.createElement("div", null, this.renderInputContainer(), r2);
    }
    return import_react3.default.createElement(rr, { className: this.props.popperClassName, wrapperClassName: this.props.wrapperClassName, hidePopper: !this.isCalendarOpen(), portalId: this.props.portalId, portalHost: this.props.portalHost, popperModifiers: this.props.popperModifiers, targetComponent: this.renderInputContainer(), popperContainer: this.props.popperContainer, popperComponent: t3, popperPlacement: this.props.popperPlacement, popperProps: this.props.popperProps, popperOnKeyDown: this.onPopperKeyDown, enableTabLoop: this.props.enableTabLoop, showArrow: this.props.showPopperArrow });
  } }], [{ key: "defaultProps", get: function() {
