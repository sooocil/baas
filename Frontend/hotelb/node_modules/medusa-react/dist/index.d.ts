...
interface MedusaProviderProps {
     ...
     */
    medusaClient?: _medusajs_medusa_js__default;
}
/**
 ...
 * @customNamespace Providers.Medusa
 */
declare const MedusaProvider: ({ queryClientProviderProps, baseUrl, apiKey, publishableApiKey, customHeaders, maxRetries, children, medusaClient, }: MedusaProviderProps) => React.JSX.Element;
...
declare const adminCustomerGroupKeys: {
    detailCustomer(id: string, query?: AdminGetCustomersParams): (string | {
        ...
        created_at?: _medusajs_medusa.DateComparisonOperator | undefined;
        updated_at?: _medusajs_medusa.DateComparisonOperator | undefined;
    })[];
...
declare const adminProductKeys: {
    detailVariants(id: string, query?: any): readonly ["admin_products", "detail", string, "variants", any];
    all: ["admin_products"];
    lists: () => ["admin_products", "list"];
    list: (query?: any) => ["admin_products", "list", {
        query: any;
    }];
    details: () => ["admin_products", "detail"];
    detail: (id: string) => ["admin_products", "detail", string];
};
...
declare const useAdminProductVariants: (id: string, query?: AdminGetProductsVariantsParams, options?: UseQueryOptionsWrapper<Response<AdminProductsListVariantsRes>, Error, ReturnType<ProductQueryKeys["detailVariants"]>>) => {
    readonly error: Error;
    readonly isError: true;
    readonly isLoading: false;
    readonly isLoadingError: false;
    ...
    readonly isRefetching: boolean;
    readonly isStale: boolean;
    readonly refetch: <TPageData>(options?: (_tanstack_react_query.RefetchOptions & _tanstack_react_query.RefetchQueryFilters<TPageData>) | undefined) => Promise<_tanstack_react_query.QueryObserverResult<Response<AdminProductsListVariantsRes>, Error>>;
    readonly remove: () => void;
    readonly fetchStatus: _tanstack_react_query.FetchStatus;
    readonly limit?: number | undefined;
    readonly offset?: number | undefined;
    readonly count?: number | undefined;
    readonly variants?: _medusajs_medusa.ProductVariant[] | undefined;
    readonly response?: _medusajs_medusa_js.HTTPResponse | undefined;
} | {
    readonly error: null;
    readonly isError: false;
 ...
 * @category Mutations
 */
declare const useAdminDeleteStockLocation: (id: string, options?: UseMutationOptions<Response<AdminStockLocationsDeleteRes>, Error, void>) => _tanstack_react_query.UseMutationResult<Response<AdminStockLocationsDeleteRes>, Error, void, unknown>;
